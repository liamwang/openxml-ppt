...
public class ThemeDefine
{
    ...
    /// Blank ColorScheme
    /// </summary>
    public static ColorScheme NewBlankColorScheme() => new(
    ...
    /// Blank FontScheme
    /// </summary>
    public static FontScheme NewBlankFontScheme() => new(
    ...
    /// Blank FormatScheme
    /// </summary>
    public static FormatScheme NewBlankFormatScheme() => new(
    ...
    /// Blank ThemeElements
    /// </summary>
    public static ThemeElements NewBlankThemeElements() => new(NewBlankColorScheme(), NewBlankFontScheme(), NewBlankFormatScheme());

    /// <summary>
    /// Blank Theme
    /// </summary>
    public static Theme NewBlankTheme() => new(NewBlankThemeElements()) { Name = "Blank" };
}
